<div class="container-fluid admin-area">
  <div class="row">
      ...
      <h2 class="content-title"><i class="fa fa-users fa-2x">  </i> Supplier List</h2>
    </div>
    <?php echo anchor('admin/user/edit', '<i class="la la-user-plus"></i> Add a Supplier', 'class="btn btn-success btn-md"'); ?>
  <!-- <h2>User List</h2> -->
