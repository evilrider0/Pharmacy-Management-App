...
<div class="container-fluid admin-area">
  <div class="row">
      ...
      <h2 class="content-title"><i class="fa fa-users fa-2x">  </i> customer List</h2>
    </div>
    <?php echo anchor('admin/user/customer_edit', '<i class="la la-user-plus"></i> Add a customer', 'class="btn btn-success btn-md"'); ?>
  <!-- <h2>User List</h2> -->
  <div class="col-12">
    <br>
      ...
      <?php
        ...
        <tr>
          ...
          <td><?php echo anchor('admin/user/customer_edit/'.$user->id, $user->name); ?></td>
          ...
          <td><?php echo bt_edit('admin/user/customer_edit/'.$user->id); ?></td>
