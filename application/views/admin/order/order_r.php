    ...
    <table class="table table-striped table-bordered" id="table">
      ...
      <?php
        ...
        <tr>
          ...
          <td><?php echo anchor('admin/order_r/process/'.$order->id, $order->order_no); ?></td>
          ...
          <td><?php echo bt_edit('admin/order_r/process/'.$order->id); ?></td>
          <td><?php echo bt_delete('admin/order_r/delete/'.$order->id); ?></td>
        </tr>
