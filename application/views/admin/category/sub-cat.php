<div class="container-fluid admin-area">
  <div class="row">
      ...
      <h2 class="content-title"><i class="fa fa-cubes fa-2x">  </i> Sub-Categories List</h2>
    </div>
    <?php echo anchor('admin/category/edit', '<i class="la la-cube"></i> Add a Sub-category', 'class="btn btn-danger btn-md"'); ?>
  <?php //dump($categorys); ?>
